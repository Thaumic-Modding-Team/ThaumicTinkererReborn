...
public class NecromancyRecipeRegistry {
    private static final Map<ResourceLocation, INecromaticRecipe> NECROMATIC_RECIPES = new HashMap<>();

    @Nullable
    public static INecromaticRecipe getRecipe(ItemStack centerStack, NonNullList<ItemStack> catalysts) {
    ...
    @Nullable
    public static INecromaticRecipe getRecipe(ResourceLocation recipeName) {
        return NECROMATIC_RECIPES.getOrDefault(recipeName, null);
    }

    @Nullable
    public static Tuple<ResourceLocation, INecromaticRecipe> getRecipeAndName(ItemStack centerStack, NonNullList<ItemStack> catalysts) {
    ...
    @Nullable
    public static ResourceLocation getRecipeName(INecromaticRecipe recipe) {
        return NECROMATIC_RECIPES.entrySet().stream()
    ...
    public static void addRecipe(ResourceLocation recipeName, INecromaticRecipe recipe) {
