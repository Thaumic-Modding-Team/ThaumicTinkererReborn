...
| Helmet of Revealing              |              | Thaiumium Helmet with Goggles of Revealing                                                                                                                                                                                     |
...
| Feature                                | Replacement | Description                                                                                               |
|:---------------------------------------|:-----------:|:----------------------------------------------------------------------------------------------------------|
| (Armor) Boots of the Horizontal Shield |             | Grants haste, step height, swim speed, jump height, and mining speed                                      |
| (Armor) Cowl of the Abyssal Depths     |             | Grants night vision, removes blindness, and grants hunger regen                                           |
| (Armor) Ichorcloth Boots               |             | Unbreakable armor that grants significant defense                                                         |
| (Armor) Ichorcloth Cowl                |             | Unbreakable armor that grants significant defense                                                         |
| (Armor) Ichorcloth Leggings            |             | Unbreakable armor that grants significant defense                                                         |
| (Armor) Ichorcloth Pouch               |             | 117 slot bag, also functions as a Focus Pouch                                                             |
| (Armor) Ichorcloth Robe                |             | Unbreakable armor that grants significant defense                                                         |
| (Armor) Leggings of the Burning Mantle |             | Grants fire resistance, extinguishes burning and grants regen, and spawns energetic nitor near the player |
| (Armor) Robes of the Stratosphere      |             | Grants creative flight and reflects arrows back at the attacker                                           |
| (Tool) Awakened Ichorium Axe           |             | Axe with three modes: normal, 5x5, tree felling mode                                                      |
| (Tool) Awakened Ichorium Pickaxe       |             | Pickaxe with three modes: normal, 5x5, and dig 10 blocks in a horizontal line                             |
| (Tool) Awakened Ichorium Shovel        |             | Shovel with three modes: normal, 5x5, and digs a 5 block vertical column                                  |
| (Tool) Awakened Ichorium Sword         |             | Sword with three modes: normal, multi-strike, and shielding                                               |
| (Tool) Ichorium Axe                    |             | Unbreakable powerful axe                                                                                  |
| (Tool) Ichorium Pickaxe                |             | Unbreakable powerful pickaxe                                                                              |
| (Tool) Ichorium Shovel                 |             | Unbreakable powerful shovel                                                                               |
| (Tool) Ichorium Sword                  |             | Unbreakable powerful sword                                                                                |
...
| Ichor                                  |             | High-tier crafting ingredient                                                                             |
| Ichor Block                            |             | High-tier crafting ingredient                                                                             |
| Ichor Cloth                            |             | High-tier crafting ingredient                                                                             |
| Ichorium Ingot                         |             | High-tier crafting ingredient                                                                             |
| Ichorium Nugget                        |             | High-tier crafting ingredient                                                                             |
...
| Crystal Scribing Tools         |                   | Scribing tools recharged with vis crystals                                                |
...
| Sword of the Dragonslayer      |                   | Deals 20% of targets max hp to dragons or players wearing Draconic Evolution armor        |
...
| Umbral Dye                     |                   | 'dyeBlack' item                                                                           |
| Umbral Rose                    |                   | Can be crushed for Umbral Dye                                                             |
...
| Feature                    |      Replacement Mod       |   Replacement Item/Block   | Reason                                                                                                  |
|:---------------------------|:--------------------------:|:--------------------------:|:--------------------------------------------------------------------------------------------------------|
| Astral Bloom               |  Magiculture Integrations  |         Auromeria          | The Auromeria from Magiculture integrations offers a much more balanced implementation of this feature. |
| Axe of the Skulltaker      |  New Crimson Revelations   |   Axe of the Skulltaker    | Improved implementation and an Infusion Enchant that mimics the function of this axe.                   |
| Blood Scrivener's Tools    |      Congrega Mystica      |  Bloody Scrivener's Tools  | Improved implementation.                                                                                |
| Bloodthorn                 |            N/A             |            N/A             | Removed due to overlap with Blood Magic's Ritual of the Forsaken Soul.                                  |
| Chameleon Axe              |  New Crimson Revelations   | Chameleon Infusion Enchant | Converted into an Infusion Enchant that can be applied to any weapon or tool.                           |
| Chameleon Pickaxe          |  New Crimson Revelations   | Chameleon Infusion Enchant | Converted into an Infusion Enchant that can be applied to any weapon or tool.                           |
| Chameleon Shovel           |  New Crimson Revelations   | Chameleon Infusion Enchant | Converted into an Infusion Enchant that can be applied to any weapon or tool.                           |
| Chameleon Sword            |  New Crimson Revelations   | Chameleon Infusion Enchant | Converted into an Infusion Enchant that can be applied to any weapon or tool.                           |
| Diabolist Fork             |            N/A             |            N/A             | Removed due to Wrath Cage removal.                                                                      |
| Eldritch Blood Orb         |      Congrega Mystica      |     Eldritch Blood Orb     | Improved implementation.                                                                                |
| Emerald Fragment           |            N/A             |            N/A             | Removed to reduce bloat.                                                                                |
| Empowered Desidia Crystal  |            N/A             |            N/A             | Removed to reduce bloat.                                                                                |
| Empowered Gula Crystal     |            N/A             |            N/A             | Removed to reduce bloat.                                                                                |
| Empowered Invidia Crystal  |            N/A             |            N/A             | Removed to reduce bloat.                                                                                |
| Empowered Ira Crystal      |            N/A             |            N/A             | Removed to reduce bloat.                                                                                |
| Empowered Lucrum Crystal   |            N/A             |            N/A             | Removed to reduce bloat.                                                                                |
...
| Tainthistle                |      Congrega Mystica      |        Tainthistle         | Improved implementation.                                                                                |
| Whisperweed                |      Congrega Mystica      |        Whisperweed         | Improved implementation.                                                                                |
| Wrath Cage                 |  Thaumic Tinkerer: Reborn  |     Necromantic Plate      | Removed to reduce duplicate features.                                                                   |
